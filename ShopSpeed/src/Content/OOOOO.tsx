...
export const OOOOO = () => {
  return (
    ...
    <div className="py-8 px-6 max-w-md bg-white bg-opacity-30 rounded-lg shadow-lg backdrop-blur-xl backdrop-filter">
        <h1 className="text-3xl font-extrabold text-center text-gray-800 mb-5">Glassmorphism Design</h1>
        <p className="text-lg text-center text-gray-700 mb-8">Using Tailwind CSS</p>
        <form className="flex flex-col">
            ...
            <div className="mb-5">
                ...
                <textarea className="bg-transparent border rounded-lg shadow border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 py-2 px-4 block w-full appearance-none leading-normal" id="message" name="message" required></textarea>
            </div>
